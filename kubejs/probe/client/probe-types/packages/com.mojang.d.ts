...
export class $PoseStack implements $IForgePoseStack, $CachingPoseStack, $PoseStackAccessor, $PoseStackExt, $PoseStackAccessor$0, $PoseStackExtension {
...
import {$BufferBuilderAccessor as $BufferBuilderAccessor$0, $BufferBuilderAccessor$Type as $BufferBuilderAccessor$0$Type} from "packages/net/createmod/ponder/mixin/client/accessor/$BufferBuilderAccessor"
...
public "localvar$bop000$vertex"(alpha: float): float
public "discard"(): void
...
(): $Function15<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), (T10), (T11), (T12), (T13), (T14), (T15), ($Function<(T16), (R)>)>
}
...
(): $Function9<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), ($BiFunction<(T10), (T11), (R)>)>
}
...
(): $Function9<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), ($Function<(T10), (R)>)>
}
...
(): $Function9<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), ($Function6<(T10), (T11), (T12), (T13), (T14), (T15), (R)>)>
}
...
(): $Function9<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), ($Function5<(T10), (T11), (T12), (T13), (T14), (R)>)>
}
...
(): $Function9<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), ($Function4<(T10), (T11), (T12), (T13), (R)>)>
}
...
(): $Function9<(T1), (T2), (T3), (T4), (T5), (T6), (T7), (T8), (T9), ($Function3<(T10), (T11), (T12), (R)>)>
}
...
public "handler$zid000$getGuiScaledWidth"(arg0: $CallbackInfoReturnable$Type<(any)>): void
public "handler$zid000$getGuiScaledHeight"(arg0: $CallbackInfoReturnable$Type<(any)>): void
public "getX"(): integer
public "getY"(): integer
public "handler$zid000$getGuiScale"(arg0: $CallbackInfoReturnable$Type<(any)>): void
