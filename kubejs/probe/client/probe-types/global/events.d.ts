...
import {$MBDRecipeTypeEvents$RecipeUIEventJS, $MBDRecipeTypeEvents$RecipeUIEventJS$Type} from "packages/com/lowdragmc/mbd2/integration/kubejs/events/$MBDRecipeTypeEvents$RecipeUIEventJS"
...
import {$MBDRecipeTypeEvents$FuelRecipeUIEventJS, $MBDRecipeTypeEvents$FuelRecipeUIEventJS$Type} from "packages/com/lowdragmc/mbd2/integration/kubejs/events/$MBDRecipeTypeEvents$FuelRecipeUIEventJS"
...
function onRecipeUI(extra: string, handler: (event: $MBDRecipeTypeEvents$RecipeUIEventJS) => void): void
function onRecipeUI(handler: (event: $MBDRecipeTypeEvents$RecipeUIEventJS) => void): void
function onFuelRecipeUI(extra: string, handler: (event: $MBDRecipeTypeEvents$FuelRecipeUIEventJS) => void): void
function onFuelRecipeUI(handler: (event: $MBDRecipeTypeEvents$FuelRecipeUIEventJS) => void): void
}
