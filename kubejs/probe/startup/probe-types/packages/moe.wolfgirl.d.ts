...
declare module "packages/moe/wolfgirl/probejs/generated/registry/scannable/ScanResultProvider" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class ScanResultProvider extends $RegistryEventJS<($Object)> {
...
declare module "packages/moe/wolfgirl/probejs/generated/registry/forgeskyboxes/SkyboxType" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
import {$Object, $Object$Type} from "packages/java/lang/$Object"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class SkyboxType extends $RegistryEventJS<($Object)> {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type SkyboxType$Type = (SkyboxType);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type SkyboxType_ = SkyboxType$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/registry/lightmanscurrency/CustomData" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
import {$Object, $Object$Type} from "packages/java/lang/$Object"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class CustomData extends $RegistryEventJS<($Object)> {
 ...
 */
declare global {
export type CustomData_ = CustomData$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/registry/lightmanscurrency/EjectionData" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
import {$Object, $Object$Type} from "packages/java/lang/$Object"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class EjectionData extends $RegistryEventJS<($Object)> {
...
declare module "packages/moe/wolfgirl/probejs/generated/registry/forgeskyboxes/LegacySkyboxDeserializer" {
import {$RegistryEventJS, $RegistryEventJS$Type} from "packages/dev/latvian/mods/kubejs/registry/$RegistryEventJS"
import {$Object, $Object$Type} from "packages/java/lang/$Object"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class LegacySkyboxDeserializer extends $RegistryEventJS<($Object)> {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type LegacySkyboxDeserializer$Type = (LegacySkyboxDeserializer);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type LegacySkyboxDeserializer_ = LegacySkyboxDeserializer$Type;
}}
