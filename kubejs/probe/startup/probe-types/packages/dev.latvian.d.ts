...
(source: $CopyNameFunction$NameSource$Type): $FunctionContainer
}
...
public "handler$chm000$loadJavaClass"(name0: string, warn: boolean, cir: $CallbackInfoReturnable$Type<(any)>): void
