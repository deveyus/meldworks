...
constructor(arg0: $Item$Properties$Type, arg1: $Function4$Type<($Level$Type), (double), (double), (double), ($Entity$Type)>)
constructor(arg0: $Item$Properties$Type, arg1: $Function4$Type<($Level$Type), (double), (double), (double), ($Entity$Type)>, arg2: string)
...
export class $AbstractTrainCarEntity extends $AbstractMinecart implements $IForgeAbstractMinecart, $LinkableEntity<($AbstractTrainCarEntity)> {
