...
readonly "backgroundColor": integer
readonly "highlightColor": integer
...
public "handler$chp000$getCapability"(cap: $Capability$Type<(any)>, side: $Direction$Type, cir: $CallbackInfoReturnable$Type<(any)>): void
...
public "handler$bng000$iris$handleHudHidingScreens"(pGui0: $GuiGraphics$Type, pFloat1: float, ci: $CallbackInfo$Type): void
...
(arg0: $FluidState$Type, arg1: $Boat$Type): boolean
}
