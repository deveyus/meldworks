...
declare module "packages/net/p3pp3rf1y/sophisticatedcore/util/$IDoubleBlock" {
import {$Optional, $Optional$Type} from "packages/java/util/$Optional"
import {$BlockState, $BlockState$Type} from "packages/net/minecraft/world/level/block/state/$BlockState"
import {$BlockPos, $BlockPos$Type} from "packages/net/minecraft/core/$BlockPos"

export interface $IDoubleBlock {

 "getOtherPosition"(arg0: $BlockState$Type, arg1: $BlockPos$Type): $Optional<($BlockPos)>

(arg0: $BlockState$Type, arg1: $BlockPos$Type): $Optional<($BlockPos)>
}

export namespace $IDoubleBlock {
const probejs$$marker: never
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type $IDoubleBlock$Type = ($IDoubleBlock);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type $IDoubleBlock_ = $IDoubleBlock$Type;
}}
...
public "getChestLidController"(): $ChestLidController
public "getOpenNess"(arg0: float): float
public "getMainChestBlockEntity"(): $ChestBlockEntity
public "getCapability"<T>(arg0: $Capability$Type<(T)>, arg1: $Direction$Type): $LazyOptional<(T)>
public "setChanged"(): void
public "onNeighborChange"(arg0: $BlockPos$Type): void
get "openersCounter"(): $SophisticatedOpenersCounter
...
get "chestLidController"(): $ChestLidController
get "mainChestBlockEntity"(): $ChestBlockEntity
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
...
import {$IdMapper, $IdMapper$Type} from "packages/net/minecraft/core/$IdMapper"
import {$IDoubleBlock, $IDoubleBlock$Type} from "packages/net/p3pp3rf1y/sophisticatedcore/util/$IDoubleBlock"
import {$BlockHitResult, $BlockHitResult$Type} from "packages/net/minecraft/world/phys/$BlockHitResult"
import {$StorageBlockEntity, $StorageBlockEntity$Type} from "packages/net/p3pp3rf1y/sophisticatedstorage/block/$StorageBlockEntity"
import {$BlockPos, $BlockPos$Type} from "packages/net/minecraft/core/$BlockPos"
import {$BlockPlaceContext, $BlockPlaceContext$Type} from "packages/net/minecraft/world/item/context/$BlockPlaceContext"
...
export class $ChestBlock extends $WoodStorageBlockBase implements $SimpleWaterloggedBlock, $IDoubleBlock {
static readonly "FACING": $DirectionProperty
...
public "getOtherPosition"(arg0: $BlockState$Type, arg1: $BlockPos$Type): $Optional<($BlockPos)>
public "onNeighborChange"(arg0: $BlockState$Type, arg1: $LevelReader$Type, arg2: $BlockPos$Type, arg3: $BlockPos$Type): void
...
export class $DecorationTableBlockEntity extends $BlockEntity {
