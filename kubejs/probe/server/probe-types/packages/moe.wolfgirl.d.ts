declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/NcOreVeins" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
...
import {$NCRecipeJS, $NCRecipeJS$Type} from "packages/igentuman/nc/compat/kubejs/$NCRecipeJS"
import {$InputParticle, $InputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$InputParticle"
 ...
 */
export class NcOreVeins extends $NCRecipeJS {


public "input"(input: ($InputItem$Type)[]): this
public "inputFluids"(inputFluids: ($InputFluid$Type)[]): this
public "inputParticles"(inputParticles: ($InputParticle$Type)[]): this
public "output"(output: ($OutputItem$Type)[]): this
public "outputFluids"(outputFluids: ($OutputFluid$Type)[]): this
public "outputParticles"(outputParticles: ($OutputParticle$Type)[]): this
public "powerModifier"(powerModifier: number): this
public "timeModifier"(timeModifier: number): this
public "radiation"(radiation: number): this
}
/**
 * Class-specific type exported by ProbeJS, use global Type_
 * types for convenience unless there's a naming conflict.
 */
export type NcOreVeins$Type = (NcOreVeins);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type NcOreVeins_ = NcOreVeins$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/AlloySmelter" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class AlloySmelter extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/KugelblitzChamber" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class KugelblitzChamber extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type KugelblitzChamber$Type = (KugelblitzChamber);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type KugelblitzChamber_ = KugelblitzChamber$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/AcceleratorCoolant" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class AcceleratorCoolant extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type AcceleratorCoolant$Type = (AcceleratorCoolant);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type AcceleratorCoolant_ = AcceleratorCoolant$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Analyzer" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Analyzer extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type Analyzer$Type = (Analyzer);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Analyzer_ = Analyzer$Type;
}}
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Centrifuge" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Centrifuge extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Electrolyzer" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Electrolyzer extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/SubatomicLiquifier" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class SubatomicLiquifier extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type SubatomicLiquifier$Type = (SubatomicLiquifier);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type SubatomicLiquifier_ = SubatomicLiquifier$Type;
}}
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/NuclearFurnace" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class NuclearFurnace extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type NuclearFurnace$Type = (NuclearFurnace);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type NuclearFurnace_ = NuclearFurnace$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/DecayHastener" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class DecayHastener extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type DecayHastener$Type = (DecayHastener);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type DecayHastener_ = DecayHastener$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Leacher" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Leacher extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type Leacher$Type = (Leacher);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Leacher_ = Leacher$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/IngotFormer" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class IngotFormer extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type IngotFormer$Type = (IngotFormer);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type IngotFormer_ = IngotFormer$Type;
}}
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FusionCore" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FusionCore extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type FusionCore$Type = (FusionCore);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type FusionCore_ = FusionCore$Type;
}}
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FluidInfuser" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FluidInfuser extends $NCRecipeJS {
 ...
 */
declare global {
export type FluidInfuser_ = FluidInfuser$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/TurbineController" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class TurbineController extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type TurbineController$Type = (TurbineController);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type TurbineController_ = TurbineController$Type;
}}
...
import {IngotFormer, IngotFormer$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/IngotFormer"
import {Shaped, Shaped$Type} from "packages/moe/wolfgirl/probejs/generated/schema/kubejs/Shaped"
import {NcOreVeins, NcOreVeins$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/NcOreVeins"
import {FusionCoolant, FusionCoolant$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FusionCoolant"
import {FusionCore, FusionCore$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FusionCore"
import {Leacher, Leacher$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Leacher"
import {ChemicalReactor, ChemicalReactor$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/ChemicalReactor"
import {Pump, Pump$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Pump"
import {SteamTurbine, SteamTurbine$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/SteamTurbine"
import {$OutputItem, $OutputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$OutputItem"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {Irradiator, Irradiator$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Irradiator"
import {NuclearFurnace, NuclearFurnace$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/NuclearFurnace"
import {FluidInfuser, FluidInfuser$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FluidInfuser"
import {Supercooler, Supercooler$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Supercooler"
import {FuelReprocessor, FuelReprocessor$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FuelReprocessor"
import {FissionReactorController, FissionReactorController$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FissionReactorController"
...
import {RockCrusher, RockCrusher$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/RockCrusher"
import {AcceleratorCoolant, AcceleratorCoolant$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/AcceleratorCoolant"
...
import {Melter, Melter$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Melter"
...
import {Analyzer, Analyzer$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Analyzer"
import {Electrolyzer, Electrolyzer$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Electrolyzer"
import {Pressurizer, Pressurizer$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Pressurizer"
import {FluidEnricher, FluidEnricher$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FluidEnricher"
...
import {FissionBoiling, FissionBoiling$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FissionBoiling"
import {$InputParticle, $InputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$InputParticle"
import {GasScrubber, GasScrubber$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/GasScrubber"
import {Manufactory, Manufactory$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Manufactory"
import {Stonecutting, Stonecutting$Type} from "packages/moe/wolfgirl/probejs/generated/schema/minecraft/Stonecutting"
import {Centrifuge, Centrifuge$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Centrifuge"
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {Upgrade, Upgrade$Type} from "packages/moe/wolfgirl/probejs/generated/schema/dankstorage/Upgrade"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
import {Crystallizer, Crystallizer$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Crystallizer"
import {Extractor, Extractor$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Extractor"
import {TargetChamber, TargetChamber$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/TargetChamber"
import {KugelblitzChamber, KugelblitzChamber$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/KugelblitzChamber"
...
import {AlloySmelter, AlloySmelter$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/AlloySmelter"
import {CraftingShaped, CraftingShaped$Type} from "packages/moe/wolfgirl/probejs/generated/schema/minecraft/CraftingShaped"
import {TurbineController, TurbineController$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/TurbineController"
import {ShapedTable, ShapedTable$Type} from "packages/moe/wolfgirl/probejs/generated/schema/extendedcrafting/ShapedTable"
import {Assembler, Assembler$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Assembler"
import {SmithingTrim, SmithingTrim$Type} from "packages/moe/wolfgirl/probejs/generated/schema/minecraft/SmithingTrim"
import {IsotopeSeparator, IsotopeSeparator$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/IsotopeSeparator"
import {SubatomicLiquifier, SubatomicLiquifier$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/SubatomicLiquifier"
import {DecayHastener, DecayHastener$Type} from "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/DecayHastener"
...
export class DocumentedRecipes {
 ...
 "nuclearcraft": {fusion_core(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): FusionCore, rock_crusher(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): RockCrusher, decay_hastener(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): DecayHastener, irradiator(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Irradiator, fission_boiling(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): FissionBoiling, extractor(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Extractor, nuclear_furnace(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): NuclearFurnace, electrolyzer(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Electrolyzer, pressurizer(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Pressurizer, alloy_smelter(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): AlloySmelter, melter(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Melter, analyzer(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Analyzer, ingot_former(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): IngotFormer, pump(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Pump, fuel_reprocessor(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): FuelReprocessor, accelerator_coolant(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): AcceleratorCoolant, nc_ore_veins(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): NcOreVeins, leacher(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Leacher, crystallizer(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Crystallizer, fission_reactor_controller(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): FissionReactorController, fusion_coolant(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): FusionCoolant, assembler(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Assembler, target_chamber(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): TargetChamber, steam_turbine(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): SteamTurbine, turbine_controller(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): TurbineController, supercooler(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Supercooler, subatomic_liquifier(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): SubatomicLiquifier, kugelblitz_chamber(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): KugelblitzChamber, centrifuge(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Centrifuge, chemical_reactor(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): ChemicalReactor, fluid_infuser(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): FluidInfuser, isotope_separator(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): IsotopeSeparator, fluid_enricher(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): FluidEnricher, gas_scrubber(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): GasScrubber, manufactory(input?: ($InputItem$Type)[], inputFluids?: ($InputFluid$Type)[], inputParticles?: ($InputParticle$Type)[], output?: ($OutputItem$Type)[], outputFluids?: ($OutputFluid$Type)[], outputParticles?: ($OutputParticle$Type)[], powerModifier?: number, timeModifier?: number, radiation?: number): Manufactory}
 "meadow": {}
 "framedblocks": {}
 "lightmanscurrency": {}
 "tombstone": {}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FissionReactorController" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FissionReactorController extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type FissionReactorController$Type = (FissionReactorController);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type FissionReactorController_ = FissionReactorController$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FusionCoolant" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FusionCoolant extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type FusionCoolant$Type = (FusionCoolant);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type FusionCoolant_ = FusionCoolant$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Pressurizer" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Pressurizer extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type Pressurizer$Type = (Pressurizer);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Pressurizer_ = Pressurizer$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Extractor" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Extractor extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Irradiator" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Irradiator extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type Irradiator$Type = (Irradiator);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Irradiator_ = Irradiator$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FuelReprocessor" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FuelReprocessor extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type FuelReprocessor$Type = (FuelReprocessor);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type FuelReprocessor_ = FuelReprocessor$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FissionBoiling" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FissionBoiling extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type FissionBoiling$Type = (FissionBoiling);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type FissionBoiling_ = FissionBoiling$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Manufactory" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Manufactory extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type Manufactory$Type = (Manufactory);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Manufactory_ = Manufactory$Type;
}}
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/RockCrusher" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class RockCrusher extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type RockCrusher$Type = (RockCrusher);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type RockCrusher_ = RockCrusher$Type;
}}
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Melter" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Melter extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type Melter$Type = (Melter);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Melter_ = Melter$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/ChemicalReactor" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class ChemicalReactor extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/IsotopeSeparator" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class IsotopeSeparator extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type IsotopeSeparator$Type = (IsotopeSeparator);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type IsotopeSeparator_ = IsotopeSeparator$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Pump" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Pump extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/GasScrubber" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class GasScrubber extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type GasScrubber$Type = (GasScrubber);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type GasScrubber_ = GasScrubber$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Assembler" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Assembler extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Crystallizer" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Crystallizer extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/TargetChamber" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class TargetChamber extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type TargetChamber$Type = (TargetChamber);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type TargetChamber_ = TargetChamber$Type;
}}
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/SteamTurbine" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class SteamTurbine extends $NCRecipeJS {
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/FluidEnricher" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class FluidEnricher extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type FluidEnricher$Type = (FluidEnricher);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type FluidEnricher_ = FluidEnricher$Type;
}}
...
declare module "packages/moe/wolfgirl/probejs/generated/schema/nuclearcraft/Supercooler" {
import {$InputFluid, $InputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$InputFluid"
import {$OutputParticle, $OutputParticle$Type} from "packages/igentuman/nc/compat/kubejs/$OutputParticle"
import {$OutputFluid, $OutputFluid$Type} from "packages/dev/latvian/mods/kubejs/fluid/$OutputFluid"
import {$InputItem, $InputItem$Type} from "packages/dev/latvian/mods/kubejs/item/$InputItem"
 ...
 * Loading the class will not throw an error, but instead the class loaded will be undefined.
 */
export class Supercooler extends $NCRecipeJS {
 ...
 * types for convenience unless there's a naming conflict.
 */
export type Supercooler$Type = (Supercooler);
/**
 * Global type exported for convenience, use class-specific
 * types if there's a naming conflict.
 */
declare global {
export type Supercooler_ = Supercooler$Type;
}}
